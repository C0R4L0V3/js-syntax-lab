...
// The Array.prototype.map() method is used to iterate over array1. For every element in array1, it will call upon the provided function. When the function is called upon, it receives the current element being processed as an argument. The value returned from the function will take the place of the original element in the new array.The Array.prototype.map() method is used to iterate over array1. For every element in array1, it will call upon the provided function. When the function is called upon, it receives the current element being processed as an argument. The value returned from the function will take the place of the original element in the new array.
...
const multiplyTwo = nums.map((num) => {
    return num * 2;
})
...
const [veggieOne, veggieTwo, veggieThree] = pizzaToppings;

console.log(veggieOne);
console.log(veggieTwo);
...
// ~~~~~~~~~~~~~~~~~~~~~~ 4: Applying the spread operator on arrays
...
const stringFunct = (noun = 'cat', adjective = 'white') => {
    console.log(`The ${noun} is ${adjective}`);
}

stringFunct('bear')

// =========================== this should be added! to the material! ===========================

// To only override the second parameter (and not the first), you need to explicitly pass undefined for the first parameter to keep its default value:

stringFunct(undefined, 'orange') // logs The cat is orange
...
//  2 True Expression: The value assigned to the variable if the condition is true, located immediate
...
let delicious = pizza === 'tasty' ? 'yum' : 'yuck'
